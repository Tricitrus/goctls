...
{{if .useI18n}}    "github.com/Tricitrus/tricitrus-admin-common/i18n"{{else}}
	"github.com/Tricitrus/tricitrus-admin-common/msg/errormsg"{{end}}{{if or .hasUUID .useUUID}}
	"github.com/Tricitrus/tricitrus-admin-common/utils/uuidx"{{end}}{{if .hasTime}}
	"github.com/Tricitrus/tricitrus-admin-common/utils/pointy"{{end}}
